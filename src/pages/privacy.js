...
export default function Privacy(){
   ...
   useEffect(()=>{
      document.getElementById('tab_title').innerHTML = 'Privacy Policy | BloodHelper'
   }, [])
   ...
   if(localStorage.getItem('user') == '' || localStorage.getItem('user') == undefined || localStorage.getItem('user') == null){
    return(
     ...
     <p>
         ShaheerDevs built the "BloodHelper" application as
         a Free app. This SERVICE is provided by
         ShaheerDevs at no cost and is intended for use as
         is.
     </p>
     <p>
     ...
     <p>
         ...
         identifiable information, including but not limited to Username, Age and Phone Number. The information that
         we request will be retained by us and used as described in this privacy policy.
     </p>
     <div>
         <p>
             The app does use third party services that may collect
             information used to identify you but you can opt-out from their program
     ...
     <p>This policy is effective as of 2021-07-11</p>
     <p><strong>Contact Us</strong></p>
     <p>
         If you have any questions or suggestions about our
         Privacy Policy, do not hesitate to contact us at shaheerdevs@gmail.com.
     </p>
